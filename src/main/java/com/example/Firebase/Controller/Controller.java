...
public class Controller {
    ...
    @PostMapping("/create")
    public UserData createuser(@RequestBody UserData userData) throws ExecutionException, InterruptedException {
        return firebaseService.saveUserDetails(userData);
